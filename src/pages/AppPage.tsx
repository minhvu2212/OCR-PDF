...
export default function AppPage() {
  ...
  const startConversion = useCallback(async () => {
    ...
    try {
      ...
      const result = await pdfOcrService.convertPdfToSearchable(file, options, setProgress);
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          <FileUploader file={file} onFileChange={handleFileChange} isProcessing={isProcessing} />
          ...
          {isProcessing && progress && <ConversionProgress progress={progress} />}
