  ...
  const features = [
    {
      ...
      description: "Chuyển đổi PDF scan thành dạng có thể tìm kiếm để dễ dàng tìm kiếm và sao chép nội dung."
    },
    {
      icon: <Lock className="h-8 w-8 text-blue-500" />,
      title: "An toàn & riêng tư",
      description: "Tất cả quá trình xử lý diễn ra ngay trên trình duyệt của bạn, không cần tải lên máy chủ."
    },
    {
    ...
    },
    {
      ...
      description: "Nhận dạng văn bản bằng nhiều ngôn ngữ, bao gồm Tiếng Việt, Anh, và nhiều ngôn ngữ khác."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="py-20 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Công cụ OCR miễn phí, hoạt động ngay trên trình duyệt của bạn, không cần tải lên máy chủ.
          </p>
          <Link to="/app">
        ...
        <section className="py-16 bg-gray-50 rounded-xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Công cụ hiện đại giúp bạn chuyển đổi PDF dạng ảnh sang PDF có thể tìm kiếm một cách dễ dàng
            </p>
          </div>
